...
layout = dbc.Col([
                ...
                html.P("By DATAX", className="text-info"),
                html.Hr(),
    ...
    #seção NOVO
                dbc.Row([
                    dbc.Col([
                        ...
                        children=['+Receita'])
                    ],style={'border-radius':'10px'}, width=6),
                    dbc.Col([
        ...
        dbc.ModalBody([
            ...
            dbc.Row([
                ...
                dbc.Col([
                    dbc.Label('Extras: '),
                    dbc.Checklist(
                        options=[{"label": "Receita Recorrente", "value":2},
...
# add/ remover categorias despesas
@app.callback(
...
# add/ remover categorias receitas
#verificar pq não ta pegando
@app.callback(
